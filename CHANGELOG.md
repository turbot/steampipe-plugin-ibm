...
- Recompiled plugin with Go version `1.24`. ([#127](https://github.com/turbot/steampipe-plugin-ibm/pull/127))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#128](https://github.com/turbot/steampipe-plugin-ibm/pull/128))
